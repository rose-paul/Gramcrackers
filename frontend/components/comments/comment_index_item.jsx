...
const CommentIndexItem = ({ comment, currentUser, commentOptionsModal, postUser, feedItem, clickHandler  }) => {
       ...
       <div className={klass}>
            ...
            {comment.user_id === currentUser.id || postUser === currentUser.id ?
                <div onClick={() => commentOptionsModal('commentoptions', comment, clickHandler)}>
